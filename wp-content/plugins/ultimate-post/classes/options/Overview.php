                    ...
                    <div class="ultp-overview-wrap">
                        ...
                        <div class="ultp-admin-sidebar">
                            <div class="ultp-sidebar ultp-admin-card">
                                ...
                                <p><?php esc_html_e('Gutenberg Post Block plugin helps to create beautiful post grid, post listing, dynamic post slider and post carousel within a few seconds.', 'ultimate-post'); ?></p>
                ...
                <div class="ultp-content-wrap">
                    <div class="ultp-featured-item ultp-admin-card">   
                        ...
                        <div class="ultp-featured-content">     
                            ...
                            <p><?php _e('Gutenberg Post Blocks comes with a rich and beautiful ready-made starter pack and design library. It helps you create a beautiful website without the knowledge of web design.', 'ultimate-post'); ?></p>       
                        ...
                        <div class="ultp-feature-items">    
                            ...
                            <div class="ultp-feature-item"> 
                                ...
                                <div class="ultp-feature-content">    
                                    ...
                                    <div><?php _e('Gutenberg Post Blocks comes with an AJAX-powered Pagination system, that’s why content is loaded without reloading the whole page.', 'ultimate-post'); ?></div>
                                </div>
                            </div>
                            <div class="ultp-feature-item">    
                                <div class="ultp-feature-image">    
                                ...
                                <div class="ultp-feature-content">    
                                    ...
                                    <div><?php _e('Typography is one of the major concerns for readability. Gutenberg Post Blocks accumulates all the Google free fonts in one place for your convenience.', 'ultimate-post'); ?></div>
                                </div>
                            </div>
                            <div class="ultp-feature-item"> 
                                <div class="ultp-feature-image">    
